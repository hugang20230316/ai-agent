...
- 优先使用只读命令：`hermes --version`、`hermes --help`、`hermes doctor`、`hermes status`、`hermes dump`、`hermes skills list`、`hermes tools list`、`hermes mcp list`、`hermes cron status`、`hermes cron list`、`hermes gateway status`、`hermes gateway list`、`hermes dashboard --status`。
